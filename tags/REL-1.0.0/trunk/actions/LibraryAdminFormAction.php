...
class LibraryAdminFormAction extends Action {
	...
	// set display requirements
	  $result = array(
        ...
        'content' => 'content/admin/libraryAdminForm.php');
