...
CREATE TABLE reports (
  ...
  report_class varchar(100) NOT NULL default '',
...
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (1,'Questions by Time of Day','This report provides the count of questions for each hour of the day.','QuestionsByTimeOfDayReport');
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (2,'Questions by Date','This report provides the count of questions for each day.','QuestionsByDateReport');
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (3,'Questions by Weekday','This report provides the count of questions, counted for each day of the week.','QuestionsByWeekdayReport');
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (4,'Questions by Patron Type','This report provides the count of questions for every patron type.','QuestionsByPatronTypeReport');
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (6,'Questions by Question Format','This report provides the count of questions for every question format.','QuestionsByQuestionFormatReport');
INSERT INTO reports (report_id, report_name, report_description, report_class) VALUES (8,'Data Dump','Sends a complete dump of report data to your computer for manipulation in a spreadsheet. <a href = \"http://www.microsoft.com/businesssolutions/excel_pivot_tables_collins.mspx\">Pivot Tables</a> are fantastic for this.','DataCSVReport');
